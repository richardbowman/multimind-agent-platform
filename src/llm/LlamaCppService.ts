...
export class LlamaCppService extends BaseLLMService implements IEmbeddingService {
                        ...
                        if (response.statusCode === 302 && response.headers.location) {
                            ...
                            https.get(redirectUrl, redirectResponse => {
                                ...
                                redirectResponse.on('data', (chunk) => {
                                    ...
                                    Logger.progress(`Downloading ${bytesDownloaded}/${totalSize} bytes${percentFormatted} of ${modelName}`, percent/100);
                                });
    ...
    async initializeModel(modelId: string, modelType: 'chat' | 'embedding'): Promise<void> {
        try {
            ...
            throw new ConfigurationError("Failed to initialize Llama.cpp embedding model. See logs.");
        }
    }
