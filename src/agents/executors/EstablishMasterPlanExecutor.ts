 ...
 */
@StepExecutorDecorator(ExecutorType.ESTABLISH_MASTER_PLAN, 'Establish the master plan for the agent.')
export class EstablishMasterPlanExecutor implements StepExecutor {
    ...
    async execute(params: ExecuteParams): Promise<StepResult> {
        ...
        if (result.masterPlan && result.masterPlan.plan) {
